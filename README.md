...
* Check the `ConnectionStrings` in `appsettings.json` files under the `ToDoList.Web` and `ToDoList.DbMigrator` projects and change it if you need.
...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9f0e1154-5f1a-4036-b410-9f5d9abe6479
```

> `9f0e1154-5f1a-4036-b410-9f5d9abe6479` is the password of the certificate, you can change it to any password you want.
...
* `ToDoList.Web`: ASP.NET Core MVC / Razor Pages application that is the essential web application of the solution.
